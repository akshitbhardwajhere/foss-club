...
exports.approveCommunityRequest = exports.submitContactForm = void 0;
 ...
 * @returns {Promise<void>}
 */
const approveCommunityRequest = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
    ...
    <tr>
      <td align="center" style="padding:40px 20px;">
        ...
        if (rowIndex && SHEET_ID) {
            try {
                yield google_1.sheets.spreadsheets.values.update({
                    spreadsheetId: SHEET_ID,
