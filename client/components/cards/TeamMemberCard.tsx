                ...
                <Dialog>
                    <DialogTrigger asChild>
                        <div className="flex flex-col items-center gap-2 cursor-pointer w-full group relative">
                            <div className={`w-full aspect-square rounded-[12px] bg-zinc-800 p-[3px] relative group-hover:ring-2 ring-0 transition-all ${isAlumni ? 'hover:ring-yellow-500' : 'hover:ring-[#08B74F]'}`}>
                                {member.role === 'Team Lead' && (
