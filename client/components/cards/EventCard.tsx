    ...
    <Link href={`/events/${event.id}`}>
      ...
      >
        <div className="absolute top-4 right-4 z-10 flex gap-2">
          ...
          {isLive ? (
            <div className="flex items-center gap-2 px-3 py-1 rounded-full text-xs font-bold backdrop-blur-md shadow-lg bg-red-500/15 text-red-400 border border-red-500/40">
            ...
            <span
              className={`px-3 py-1 rounded-full text-xs font-bold backdrop-blur-md shadow-lg ${isActuallyPast ? "bg-zinc-800/80 text-zinc-300 border border-zinc-700" : "bg-[#08B74F] text-black border border-[#08B74F]/50"}`}
            >
        ...
        <div className="p-6 flex flex-col flex-grow">
          <h2 className="text-xl font-bold mb-3 group-hover:text-[#08B74F] transition-colors">
            {event.title}
          </h2>
