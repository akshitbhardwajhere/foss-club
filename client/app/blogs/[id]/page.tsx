    ...
    if (!blog) {
        return (
            <div className="bg-[#050B08] min-h-screen flex flex-col items-center justify-center text-white">
                ...
                <button onClick={() => router.push('/blogs')} className="text-[#08B74F] hover:underline flex items-center gap-2 font-medium">
                ...
                >
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex flex-col text-left">
                                    <span className="font-semibold text-zinc-200 text-sm">{blog.author}</span>
                                    <span className="text-[10px] uppercase tracking-widest text-zinc-500">Author</span>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex flex-col text-left">
                                    <span className="font-semibold text-zinc-200 text-sm">{formattedDate}</span>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex flex-col text-left">
                                    <span className="font-semibold text-zinc-200 text-sm">{readTime} min</span>
                                    <span className="text-[10px] uppercase tracking-widest text-zinc-500">Read time</span>
                                </div>
                            </div>
                        </motion.div>
                    ...
                    <div className="border-t border-zinc-800/40 px-6 md:px-12 lg:px-16 py-6 flex flex-wrap items-center justify-between gap-4">
                        <div className="flex items-center gap-2 text-zinc-500 text-xs">
                            ...
                            <span>Written by <span className="text-zinc-300 font-medium">{blog.author}</span></span>
                        </div>
                        {blog.tags?.length > 0 && (
                            <div className="flex flex-wrap gap-1.5">
                                {blog.tags.map((tag, idx) => (
                                    <span key={idx} className="text-[10px] font-medium text-zinc-500 bg-zinc-800/50 px-2.5 py-1 rounded-full">
                                        #{tag}
                                    </span>
                                ))}
                            </div>
