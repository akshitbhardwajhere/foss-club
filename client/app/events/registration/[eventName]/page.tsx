...
import { Link as LinkIcon, Building2, User, Users, BookOpen, AlertCircle, ArrowRight, CheckCircle2 } from "lucide-react";
...
const formSchema = z.object({
    ...
    teamMembers: z.string().optional(), // We'll parse this into an array
    ...
    useEffect(() => {
        const fetchConfig = async () => {
            ...
            try {
                ...
                setError(err.response?.data?.message || "Registration closed or not found.");
            } finally {
                setLoading(false);
            }
        };
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        ...
        try {
            ...
            const teamMembersArray = values.teamMembers
                ? values.teamMembers.split(",").map(s => s.trim()).filter(Boolean).slice(0, 5)
                : [];
        ...
        return (
            <div className="min-h-screen bg-[#050B08] flex flex-col items-center justify-center p-4">
                <div className="bg-zinc-900 border border-zinc-800 p-8 rounded-2xl max-w-md w-full text-center space-y-4">
                    ...
                    <h1 className="text-xl font-bold text-white">Registration Unavailable</h1>
                    <p className="text-zinc-400 text-sm">{error || "This form is no longer active."}</p>
                </div>
            </div>
        );
    }
            ...
            <div className="min-h-screen bg-[#050B08] flex items-center justify-center p-4">
                ...
                >
                    ...
                    <p className="text-zinc-400 text-sm">
                        Thank you for registering for {config.event.title}. We've received your details.
                    </p>
                    <div className="pt-6">
                        <a href="/" className="inline-flex items-center gap-2 text-[#08B74F] hover:underline text-sm font-medium">
        ...
        return (
            <div className="min-h-screen bg-[#050B08] flex flex-col items-center justify-center p-4">
                <div className="bg-zinc-900 border border-zinc-800 p-8 rounded-2xl max-w-md w-full text-center space-y-4">
                    ...
                    <p className="text-zinc-400 text-sm">The deadline to register for this event has passed.</p>
                </div>
            </div>
        );
    }
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel className="text-xs font-medium text-zinc-300">Full Name <span className="text-red-500">*</span></FormLabel>
                                                <FormControl>
                                                    <Input placeholder="John Doe" className="bg-[#111e16] border-[#1b3123] h-11 focus-visible:ring-[#08B74F] text-white" {...field} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel className="text-xs font-medium text-zinc-300">Email Address <span className="text-red-500">*</span></FormLabel>
                                                <FormControl>
                                                    <Input type="email" placeholder="john@example.com" className="bg-[#111e16] border-[#1b3123] h-11 focus-visible:ring-[#08B74F] text-white" {...field} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel className="text-xs font-medium text-zinc-300">Institute Name <span className="text-red-500">*</span></FormLabel>
                                                <FormControl>
                                                    <Input placeholder="NIT Srinagar" className="bg-[#111e16] border-[#1b3123] h-11 focus-visible:ring-[#08B74F] text-white" {...field} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel className="text-xs font-medium text-zinc-300">Branch / Major <span className="text-red-500">*</span></FormLabel>
                                                <FormControl>
                                                    <Input placeholder="Computer Science" className="bg-[#111e16] border-[#1b3123] h-11 focus-visible:ring-[#08B74F] text-white" {...field} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel className="text-xs font-medium text-zinc-300">Enrollment No. <span className="text-zinc-500 font-normal">(if NIT Student)</span></FormLabel>
                                                <FormControl>
                                                    <Input placeholder="e.g. 2023BMEXXX" className="bg-[#111e16] border-[#1b3123] h-11 focus-visible:ring-[#08B74F] text-white" {...field} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel className="text-xs font-medium text-zinc-300">Area of Interest <span className="text-red-500">*</span></FormLabel>
                                                <FormControl>
                                                    <div className="relative group/select">
                                                        <select
                                                            ...
                                                            {...field}
                                                        >
                                                            <option value="" disabled className="bg-zinc-900 text-zinc-500">Select area of interest</option>
                                                            <option value="Web Development" className="bg-zinc-900">Web Development</option>
                                                            <option value="App Development" className="bg-zinc-900">App Development</option>
                                                            <option value="Artificial Intelligence / ML" className="bg-zinc-900">Artificial Intelligence / ML</option>
                                                            ...
                                                            <option value="Cloud Computing" className="bg-zinc-900">Cloud Computing</option>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-2 pb-2 border-b border-zinc-800">
                                    ...
                                    <h2 className="text-lg font-semibold text-white">Participation Type</h2>
                                </div>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className="text-xs font-medium text-zinc-300">Are you participating as an individual or a team? <span className="text-red-500">*</span></FormLabel>
                                            <FormControl>
                                                <div className="relative group/select w-full md:w-1/2">
                                                    <select
                                                        ...
                                                        {...field}
                                                    >
                                                        <option value="" disabled className="bg-zinc-900 text-zinc-500">Select option</option>
                                                        <option value="true" className="bg-zinc-900">Individual</option>
                                                        <option value="false" className="bg-zinc-900">Team (Up to 5 members)</option>
                                                    </select>
                                                    <div className="pointer-events-none absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-zinc-500">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                                            <path fillRule="evenodd" d="M5.22 8.22a.75.75 0 0 1 1.06 0L10 11.94l3.72-3.72a.75.75 0 1 1 1.06 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L5.22 9.28a.75.75 0 0 1 0-1.06Z" clipRule="evenodd" />
                                    ...
                                    {isIndividualWatch === "false" && (
                                        ...
                                        >
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        <FormLabel className="text-xs font-medium text-zinc-300">Team Name <span className="text-red-500">*</span></FormLabel>
                                                        <FormControl>
                                                            <Input placeholder="e.g. Byte Busters" className="bg-[#111e16] border-[#1b3123] h-11 focus-visible:ring-[#08B74F] text-white" {...field} />
                                                        </FormControl>
                                                        <FormMessage />
                                                    </FormItem>
                                                )}
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        <FormLabel className="text-xs font-medium text-zinc-300">Team Members Names <span className="text-red-500">*</span></FormLabel>
                                                        <FormControl>
                                                            <Input placeholder="Comma separated (Max 5)" className="bg-[#111e16] border-[#1b3123] h-11 focus-visible:ring-[#08B74F] text-white" {...field} />
                                                        </FormControl>
                                                        <FormMessage />
                                                    </FormItem>
                                                )}
