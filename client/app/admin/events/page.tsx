                        ...
                        <FormControl>
                          <div className="relative">
                            <Input
                              ...
                              className="bg-[#111e16] border-[#1b3123] h-10 px-3 focus-visible:ring-[#08B74F] text-white pr-9 text-sm"
                              {...field}
                            />
                      ...
                      >
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="font-bold text-white text-sm md:text-base truncate max-w-[150px] md:max-w-xs">
                                {event.title}
                              </p>
