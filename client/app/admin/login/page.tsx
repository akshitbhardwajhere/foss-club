            ...
            >
                <div className="bg-zinc-900/80 border border-zinc-800 rounded-3xl p-8 backdrop-blur-xl shadow-2xl">
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <h1 className="text-3xl font-bold tracking-tight text-center">Admin Portal</h1>
                        <p className="text-zinc-400 text-center mt-2">Sign in to manage FOSS activities</p>
                    </div>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input placeholder="admin@fossnit.in" type="email" className="bg-zinc-950 border-zinc-800 focus-visible:ring-[#08B74F] h-12" {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input type="password" placeholder="••••••••" className="bg-zinc-950 border-zinc-800 focus-visible:ring-[#08B74F] h-12" {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
